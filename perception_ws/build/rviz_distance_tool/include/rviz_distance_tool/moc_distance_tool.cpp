...
QT_INIT_METAOBJECT const QMetaObject rviz_distance_tool::DistanceTool::staticMetaObject = { {
    &rviz::Tool::staticMetaObject,
    qt_meta_stringdata_rviz_distance_tool__DistanceTool.data,
    qt_meta_data_rviz_distance_tool__DistanceTool,
    qt_static_metacall,
    nullptr,
    nullptr
} };
